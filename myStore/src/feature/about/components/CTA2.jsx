...
function CTA2() {
  return (
    <div className="flex flex-col justify-center items-center bg-white px-16 py-20 h-[650px] w-full ">
      <h1 className="md:text-5xl text-center font-light max-w-7xl">
        At Infinity, we want the right choice to be as easy as putting on a
